...
import { ResourcesClient, type ResourceRow } from "@/app/[locale]/(portail)/portail/admin/resources/ResourcesClient";
...
export default async function StudentResourcesPage({
  ...
  // RLS automatically filters which resources the student can see (public +
  // students-visibility). Same DAM UI as admin but with canWrite=false.
